<header class="flex flex-col xs:flex-row items-center justify-between gap-4 xs:gap-0 whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-800 px-4 xs:px-6 sm:px-10 py-4">
    <div class="flex items-center gap-3 xs:gap-4 text-gray-900 dark:text-white">
        ...
        <h2 class="text-lg xs:text-xl font-bold tracking-tight">John Doe</h2>
    </div>
    <div class="flex flex-1 justify-end items-center gap-4 xs:gap-6 sm:gap-8">
        <nav class="flex items-center gap-4 xs:gap-6 sm:gap-9">
            ...
            <a class="text-xs xs:text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors" href="#">About</a>
            <a class="text-xs xs:text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors" href="#">Contact</a>
        </nav>
        <button class="flex min-w-[80px] xs:min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-8 xs:h-9 sm:h-10 px-3 xs:px-4 bg-primary text-white text-xs xs:text-sm font-bold tracking-wide hover:bg-primary/90 transition-colors">
